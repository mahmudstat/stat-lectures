...
\question \textbf{If a coin is tossed thrice, what is the probability of getting at least one head?}	\choice{\( \frac{1}{8} \)}{\( \frac{1}{4} \)}{\( \frac{3}{8} \)}{\( \frac{7}{8} \)}{d}


 \question \textbf{When tossing a coin 5 times, what is the probability of getting exactly 3 heads?}
 \choice{3}{When tossing a coin 5 times, what is the probability of getting exactly 3 heads?}{ \( \frac{10}{32} \)}{ \( \frac{16}{32} \)}{c}
