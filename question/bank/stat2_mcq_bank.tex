...
\choice{$\frac{7}{21}$}{$\frac{5}{21}$}{$\frac{1}{21}$}{$1$}{a}
...
\choice{$n \rightarrow \infty$ and $p \rightarrow \infty$}{$n \rightarrow 0$ and $p \rightarrow 0$}{$n \rightarrow \infty$ and $p \rightarrow 0$}{$n \rightarrow 0$ and $p \rightarrow \infty$}{a}
...
\choice{$\frac 1{\sqrt m}$}{$m$}{$\frac 1m$}{$1+\frac 1m$}{a}
