...
\choice{0.0896}{0.2131}{0.2253}{0.2942}{c}  

\question \textbf{In a binomial distribution with $p = 0.5$ and $n = 8$, what is $P(4)$?}  
\choice{0.6367}{0.3125}{0.2070}{0.0898}{a}  

\question \textbf{In a binomial distribution with $p = 0.2$ and $n = 15$, what is $P(5)$?}  
\choice{0.1789}{0.1887}{0.9389}{0.2413}{c}  

\question \textbf{In a binomial distribution with $p = 0.6$ and $n = 9$, what is $P(6)$?}  
\choice{0.2007}{0.2508}{0.2311}{0.7682}{d}  

\question \textbf{In a binomial distribution with $p = 0.3$ and $P(x) = 0.3828$, $n=?$}  
\choice{18}{10}{13}{6}{b}  

\question \textbf{In a binomial distribution with $p = 0.4$ and $P(x) = 0.2253$, $n=?$}  
\choice{5}{6}{12}{15}{c}  

\question \textbf{In a binomial distribution with $p = 0.5$ and $P(x) = 0.6367$, $n=?$}  
\choice{15}{1}{8}{0.0898}{c}  
...
\question \textbf{If a Poisson-distributed random variable has mean $\lambda = 6$, which of the following statements is true?}
