...
\end{table}
  ...
  \item
	  \textbf{In a dope test, the proability of correct identification of drug use is 0.90 and that of correct identification of non-use for non-users is 0.80. The probability of drug use is 0.05 and of detection 0.235. } 
  
  \begin{enumerate}
    \item
	Write down the formula of conditional probability. \hfill 1
    \item
	Write down $P(A|B)$ in terms of $P(B|A)$. \hfill 2
    \item  
	Question \hfill 3
    \item
	Question \hfill 4
...
\section{Creative Questions}
  ...
  \end{enumerate}
   ...
   \item
	  \textbf{The probability distributions of a random variable X in dtwo different cases are given below:} 
