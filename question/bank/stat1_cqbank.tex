...
\section{Short Questions}
  ...
  \begin{enumerate}
    ...
    \item What are the components of Time Series?
    \item What is trend?
    \item How many types of trends are there?
    \item What is linear trend?
    \item What is non-linear trend?
    \item What is seasonal variation?
    \item Give an example of seasonal variation.
    \item What is cyclic variation.
    \item Distinguish between seasonal and cyclic variation.
    \item Give an example of cyclic variation.
    \item What is irregular variation?
    \item What is an example of irregular variation?
    \item How many modelss are there for time series?
    \item Mention the additive model of time series.
    \item What is the mulplicative model?
    \item How many methods are there to measure the trend?
    \item What are the weaknesses of graphical method of measuring the trend?
