...
\subsection{General Questions}
    ...
    \item For two non-zero values, what is the relationship among AM, GM, and HM?
...
\subsection{Arithmetic Mean}
    ...
    \item Derive the formula of Arithmetic Mean for short-cu method.
    ...
    \item If $u_i = x_i + y_i$, what is $\bar x$?
    \item For two numbers, $AM=25$ and $GM=15$. $HM=?$
...
\subsection{Median}
    ...
    \item Median score of 50 students is 70. What does it mean?
