...
button.tool.active { background: yellow; }
button.tool { padding: 5px 10px; cursor: pointer; }
</style>
...
(() => {
  ...
  let drawing = false, tool = 'pen', penColor = '#000000';
  ...
  window.addEventListener('resize', () => {
    const temp = ctx.getImageData(0, 0, board.width, board.height);
    board.width = window.innerWidth;
    board.height = window.innerHeight;
