...
output:
  revealjs::revealjs_presentation:
    ...
    css:
      - css/styles.css
    includes:
      # We no longer include header.html directly here.
      # Instead, we inject it via JavaScript.
      after_body: css/inject_footer.js # Inject JavaScript after body for best practice
---

## Previous Chapter 

[Introduction to Probability](01-probability-intro)
