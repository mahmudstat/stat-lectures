...
$GM=(x_1 \times x_2 \times \cdots \times x_n)^{(1/n)}$ or
$GM=(x_1^{f_1} \times x_2^{f_2} \times \cdots \times x_n^{f_n})^{(1/\sum f_i)}$
...
<img class="plain" src="img/velocity_paradox.png" width="1100">
...
> - What now: 10,12,15,15,20, 50, 70,75,80
...
Prove using formulae

For two non-zero positive numbers, $AM \times HM =(GM)^2$

## Mean-Median of Natural Numbers
...
> - $G_1 = (x_1 x_2 x_3)^{1/3}$
> - $G_2 = (y_1 y_2 y_3)^{1/3}$
> - COmbined, G = $(x_1 y_1 \cdot x_2 y_2 \cdot x_3 y_3)^{1/3}$
> - Thus $G = G_1 \times G_2$

## GM with Log

$GM=Antilog(\frac{\sum \log x_i}{n})$

or

$Antilog(\frac{\sum f_i \log x_i}{\sum f_i})$
...
AM and GM of two positive numbers are 25 and 15, respectively. Find HM and the numbers. (click to see)
<div class="container">
<div class="col">
