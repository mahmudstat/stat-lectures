...
<small> $P(A)=\frac 1 4, P(B) = \frac 2 5, P(A\cup B) = \frac 1 2$; A & B are not mutually exclusive. Find
...
<div onclick="klikaj('sp1')">1. failed in English but passed in Math</div>
<div onclick="klikaj('sp2')">2. Passed only one subject</div>
<div onclick="klikaj('sp3')">3. Failed in none</div>
<div onclick="klikaj('sp4')">4. Passed at best one subject</div>
</div>
<div class="col">
<u>Answers</u>

<div id="sp1" style="visibility: hidden">
1. $P(E\cap S')$
</div>
<div id="sp2" style="visibility: hidden">
2. $P(E\cap S')+P(E' \cap S)$
</div>
<div id="sp3" style="visibility: hidden">
1. $P(E\cap S)' = \frac{n(E')+n(S')-n(E'\cap S')}{n(S)}$
</div>
<div id="sp4" style="visibility: hidden">
2. Fail both + Fail in one = 0.2 + 0.05
</div>
</div>
</div>
